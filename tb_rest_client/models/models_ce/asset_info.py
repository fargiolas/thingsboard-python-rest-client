...
from tb_rest_client.api_client import ApiClient
    ...
    def __init__(self, id=None, created_time=None, tenant_id=None, customer_id=None, name=None, type=None, label=None, additional_info=None, customer_title=None, customer_is_public=None):  # noqa: E501
